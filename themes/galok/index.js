...
import MobileFooter from './components/MobileFooter' // 导入新组件

const Live2D = dynamic(() => import('@/components/Live2D'))

// 主题全局状态
const ThemeGlobalGalok = createContext()
export const useGalokGlobal = () => useContext(ThemeGlobalGalok)
...
const LayoutBase = props => {
  ...
  return (
    <ThemeGlobalGalok.Provider value={{ searchModal }}>
      <div
        id='theme-galok'
